...
# placeholder, para informações filtradas que só serão carregadas depois
...
# placeholder que só vai ser carregado com o df_filtered
...
filtered_df = df[(df.data.dt.year == year_to_filter) &
                 (df.classificacao.isin(label_to_filter))]
